...
public class QueueListModel {
	...
	private final static Logger logger = Logger.getLogger(QueueListModel.class);

	public QueueListModel() {
		logger.trace("QueueListModel()");
		responses = null;
	...
	private void filterQueues() {
		...
		if (showSystemQueues) {
			...
			Vector<PCFMessage> vector = new Vector<PCFMessage>();
			...
			*/
			...
			filteredResponses = (PCFMessage[])vector.toArray(new PCFMessage[0]);
		}
		Vector<PCFMessage> vector1 = new Vector<PCFMessage>();
		 ...
		 */
		filteredResponses = (PCFMessage[])vector1.toArray(new PCFMessage[0]);
		
		vector1 = new Vector<PCFMessage>();		
	...
	public boolean isShowAliasQueues() {
		logger.trace("isShowAliasQueues()");
		return showAliasQueues;
	}

	public boolean isShowLocalQueues() {
		logger.trace("isShowLocalQueues()");
