...
public class ChannelListModel {
	...
	public void deleteChannel(String s) {
		try {
			...
			if (i != -1) {
				...
				System.arraycopy(responses, i + 1, apcfmessage, i,
						responses.length - i - 1);
	...
	public void deleteChannelStatus(String s) {
		try {
			...
			for (int j = 0; j < channelStatusResponses.length; j++) {
				String s1 = channelStatusResponses[j].getStringParameterValue(
						3501).trim();
				if (!s1.equals(s))
					continue;
				i = j;
			...
			if (i != -1) {
				...
				System.arraycopy(channelStatusResponses, i + 1, apcfmessage, i,
						channelStatusResponses.length - i - 1);
	...
	public PCFMessage findChannelStatusByName(String s) {
		...
		for (int i = 0; i < channelStatusResponses.length; i++)
			try {
				if (s.equals(channelStatusResponses[i].getStringParameterValue(
						3501).trim()))
	...
	public Object getValueAt(int i, String s) {
		...
		try {
			...
			if (s.equals("Name")) {
				...
				texticon.setText(ChannelName.toString(pcfmessage
						.getStringParameterValue(3501)));
				...
				case 1: // '\001'
					if (j == 6) {
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelSenderStopped.gif")));
						break;
					}
					if (j == 0) {
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelSender.gif")));
						break;
					}
					if (j == 3)
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelSenderRunning.gif")));
					else
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelSenderRetrying.gif")));
					break;

				case 2: // '\002'
					if (j == 6) {
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelServerStopped.gif")));
						break;
					}
					if (j == 0) {
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelServer.gif")));
						break;
					}
					if (j == 3)
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelServerRunning.gif")));
					else
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelServerRetrying.gif")));
					break;

				case 3: // '\003'
					if (j == 6) {
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelReceiverStopped.gif")));
						break;
					}
					if (j == 0) {
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelReceiver.gif")));
						break;
					}
					if (j == 3)
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelReceiverRunning.gif")));
					else
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelReceiverRetrying.gif")));
					break;

				case 4: // '\004'
					if (j == 6) {
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelRequestorStopped.gif")));
						break;
					}
					if (j == 0) {
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelRequestor.gif")));
						break;
					}
					if (j == 3)
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelRequesterRunning.gif")));
					else
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelRequestorRetrying.gif")));
					break;

				case 7: // '\007'
					if (j == 6) {
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelServerConnectionStopped.gif")));
						break;
					}
					if (j == 0)
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelServerConnection.gif")));
					else
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelServerConnectionRetrying.gif")));
					break;

				case 8: // '\b'
					if (j == 6) {
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelClusterReceiverStopped.gif")));
						break;
					}
					if (j == 0)
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelClusterReceiver.gif")));
					else
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelClusterReceiverRetrying.gif")));
					break;

				case 9: // '\t'
					if (j == 6) {
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelClusterSenderStopped.gif")));
						break;
					}
					if (j == 0)
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelClusterSender.gif")));
					else
						texticon.setIcon(new ImageIcon(getClass().getResource(
								"/icons/channelClusterSenderRetrying.gif")));
					break;
				}
				return texticon;
			}
			if (s.equals("Channel Type"))
				return ChannelType.toString(pcfmessage
						.getIntParameterValue(1511));
			if (s.equals("Protocol Type"))
				return TransportType.toString(pcfmessage
						.getIntParameterValue(1501));
			if (s.equals("Connection Name"))
				return ConnectionName.toString(pcfmessage
						.getStringParameterValue(3506));
			if (s.equals("Transmission Queue Name"))
				return ConnectionName.toString(pcfmessage
						.getStringParameterValue(3505));
			if (s.equals("Overall Channel Status"))
				return ChannelStatus.toString(pcfmessage
						.getIntParameterValue(1527));
			if (s.equals("Alteration Date (GMT)"))
				return AlterationDate.toString(pcfmessage
						.getStringParameterValue(2027));
			if (s.equals("Alteration Time (GMT)"))
				return AlterationTime.toString(pcfmessage
						.getStringParameterValue(2028));
			if (s.equals("Alteration Date/Time"))
				return AlterationDate.toString(pcfmessage
						.getStringParameterValue(2027))
						+ " "
						+ AlterationTime.toString(pcfmessage
								.getStringParameterValue(2028));
			if (s.equals("Batch Interval"))
				return BatchInterval.toString(pcfmessage
						.getIntParameterValue(1564));
			if (s.equals("Batch Size"))
				return BatchSize
						.toString(pcfmessage.getIntParameterValue(1502));
			if (s.equals("Cluster Name"))
				return ClusterName.toString(pcfmessage
						.getStringParameterValue(2029));
			if (s.equals("Data Conversion"))
				return DataConversion.toString(pcfmessage
						.getIntParameterValue(1515));
			if (s.equals("Description"))
				return ChannelDesc.toString(pcfmessage
						.getStringParameterValue(3502));
			if (s.equals("Disconnection Interval"))
				return DiscInterval.toString(pcfmessage
						.getIntParameterValue(1503));
			if (s.equals("Heartbeat Interval"))
				return HeartBeatInterval.toString(pcfmessage
						.getIntParameterValue(1563));
			if (s.equals("Long Retry Count"))
				return LongRetryCount.toString(pcfmessage
						.getIntParameterValue(1507));
			if (s.equals("Long Retry Timer"))
				return LongRetryInterval.toString(pcfmessage
						.getIntParameterValue(1506));
			if (s.equals("Maximum Message Length"))
				return MaxMsgLength.toString(pcfmessage
						.getIntParameterValue(1510));
			if (s.equals("MCA Name"))
				return MCAName.toString(pcfmessage
						.getStringParameterValue(3507));
			if (s.equals("MCA Type"))
				return MCAType.toString(pcfmessage.getIntParameterValue(1517));
			if (s.equals("MCA User ID"))
				return MCAUserIdentifier.toString(pcfmessage
						.getStringParameterValue(3527));
			if (s.equals("Message Exit Name"))
				return MsgExit.toString(pcfmessage
						.getStringParameterValue(3509));
			if (s.equals("Message Exit User Data"))
				return MsgUserData.toString(pcfmessage
						.getStringParameterValue(3514));
			if (s.equals("Message Retry Count"))
				return MsgRetryCount.toString(pcfmessage
						.getIntParameterValue(1544));
			if (s.equals("Message Retry Exit Name"))
				return MsgRetryExit.toString(pcfmessage
						.getStringParameterValue(3534));
			if (s.equals("Message Retry Exit User Data"))
				return MsgRetryUserData.toString(pcfmessage
						.getStringParameterValue(3535));
			if (s.equals("Message Retry Interval"))
				return MsgRetryInterval.toString(pcfmessage
						.getIntParameterValue(1545));
			if (s.equals("Mode Name"))
				return ModeName.toString(pcfmessage
						.getStringParameterValue(3503));
			if (s.equals("Network Priority"))
				return NetworkPriority.toString(pcfmessage
						.getIntParameterValue(1565));
			if (s.equals("Non-persistent Message Speed"))
				return NonPersistentMsgSpeed.toString(pcfmessage
						.getIntParameterValue(1562));
			if (s.equals("Password"))
				return Password.toString(pcfmessage
						.getStringParameterValue(3518));
			if (s.equals("Put Authority"))
				return PutAuthority.toString(pcfmessage
						.getIntParameterValue(1508));
			if (s.equals("Receive Exit Name"))
				return ReceiveExit.toString(pcfmessage
						.getStringParameterValue(3511));
			if (s.equals("Receive Exit User Data"))
				return ReceiveUserData.toString(pcfmessage
						.getStringParameterValue(3516));
			if (s.equals("Security Exit Name"))
				return SecurityExit.toString(pcfmessage
						.getStringParameterValue(3508));
			if (s.equals("Security Exit User Data"))
				return SecurityUserData.toString(pcfmessage
						.getStringParameterValue(3513));
			if (s.equals("Send Exit Name"))
				return SendExit.toString(pcfmessage
						.getStringParameterValue(3510));
			if (s.equals("Send Exit User Data"))
				return SendUserData.toString(pcfmessage
						.getStringParameterValue(3515));
			if (s.equals("Sequence Number Wrap"))
				return SeqNumberWrap.toString(pcfmessage
						.getIntParameterValue(1509));
			if (s.equals("Short Retry Count"))
				return ShortRetryCount.toString(pcfmessage
						.getIntParameterValue(1505));
			if (s.equals("Short Retry Timer"))
				return ShortRetryInterval.toString(pcfmessage
						.getIntParameterValue(1504));
			if (s.equals("TP Name"))
				return TpName
						.toString(pcfmessage.getStringParameterValue(3503));
			if (s.equals("User ID"))
				return UserIdentifier.toString(pcfmessage
						.getStringParameterValue(3517));
		} catch (Exception _ex) {
			return "";
		}
	...
	public void refreshAll(PCFMessageAgent pcfmessageagent) {
		try {
			...
			logger.error("Exception (ChannelListModel::refreshAll): "
					+ exception.toString());
		}
	}
	...
	public void refreshChannel(PCFMessageAgent pcfmessageagent, String s) {
		try {
			...
			if (!flag) {
				...
				System.arraycopy(responses, 0, apcfmessage1, 0,
						responses.length);
			...
			logger.error("Exception:refreshChannel: " + exception.toString());
		}
	}
	...
	public void refreshChannelStatus(PCFMessageAgent pcfmessageagent, String s) {
		try {
			...
			boolean flag = false;
			for (int i = 0; i < channelStatusResponses.length; i++) {
				String s1 = channelStatusResponses[i]
						.getStringParameterValue(3501);
				if (!s1.equals(s))
					continue;
			...
			if (!flag) {
				...
				System.arraycopy(channelStatusResponses, 0, apcfmessage1, 0,
						channelStatusResponses.length);
				apcfmessage1[channelStatusResponses.length] = apcfmessage[0];
				channelStatusResponses = apcfmessage1;
			}
		} catch (Exception exception1) {
			logger.info("refreshChannelStatus:Exception: "
					+ exception1.toString());
		}
	}
	...
	public void refreshChannelStatusAll(PCFMessageAgent pcfmessageagent) {
		try {
			...
			logger.error("Exception (ChannelListModel::refreshChannelStatusAll): "
					+ exception.toString());
		}
	}
