...
// Source File Name:   XAQueueConnectionFactoryDlg.java
...
public class XAQueueConnectionFactoryDlg extends JDialog
{
        ...
        implements FooterListener, WindowListener
    {
        ...
        {
            if(windowevent.getSource() == XAQueueConnectionFactoryDlg.this)
    ...
    public XAQueueConnectionFactoryDlg()
    {
        ivjClientID = null;
        ivjDescription = null;
        ivjFactoryName = null;
    ...
    public XAQueueConnectionFactoryDlg(Dialog dialog)
    {
        super(dialog);
        ivjClientID = null;
        ivjDescription = null;
    ...
    public XAQueueConnectionFactoryDlg(Dialog dialog, String s)
    {
        super(dialog, s);
        ivjClientID = null;
        ivjDescription = null;
    ...
    public XAQueueConnectionFactoryDlg(Dialog dialog, String s, boolean flag)
    {
        super(dialog, s, flag);
        ivjClientID = null;
        ivjDescription = null;
    ...
    public XAQueueConnectionFactoryDlg(Dialog dialog, boolean flag)
    {
        super(dialog, flag);
        ivjClientID = null;
        ivjDescription = null;
    ...
    public XAQueueConnectionFactoryDlg(Frame frame)
    {
        super(frame);
        ivjClientID = null;
        ivjDescription = null;
    ...
    public XAQueueConnectionFactoryDlg(Frame frame, String s)
    {
        super(frame, s);
        ivjClientID = null;
        ivjDescription = null;
    ...
    public XAQueueConnectionFactoryDlg(Frame frame, String s, boolean flag)
    {
        super(frame, s, flag);
        ivjClientID = null;
        ivjDescription = null;
    ...
    public XAQueueConnectionFactoryDlg(Frame frame, boolean flag)
    {
        super(frame, flag);
        ivjClientID = null;
        ivjDescription = null;
    ...
    public MQXAQueueConnectionFactory getXAQueueConnectionFactory()
    {
    ...
    public void setFromXAQueueConnectionFactory(MQXAQueueConnectionFactory mqxaqueueconnectionfactory)
    {
