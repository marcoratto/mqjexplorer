...
public class ChannelDlg extends JDialog {
	...
	public void changeClusterReceiver(Frame frame,
			QueueManagerModel queuemanagermodel, String s) {
		queueManagerModel = queuemanagermodel;
		type = 2;
		try {
			PCFMessage pcfmessage = queuemanagermodel.getChannelListModel()
					.findChannelByName(s);
			getGeneral().channelNameSetValue(
					pcfmessage.getStringParameterValue(3501));
			getGeneral().channelNameSetEditable(false);
			getGeneral().channelTypeSetValue(
					pcfmessage.getIntParameterValue(1511));
			getGeneral().channelDescSetValue(
					pcfmessage.getStringParameterValue(3502));
			getGeneral().transportTypeSetValue(
					pcfmessage.getIntParameterValue(1501));
			getGeneral().connectionNameSetValue(
					pcfmessage.getStringParameterValue(3506));
			getGeneral().xmitQNameSetVisible(false);
			getGeneral().alterationDateSetValue(
					pcfmessage.getStringParameterValue(2027));
			getGeneral().alterationTimeSetValue(
					pcfmessage.getStringParameterValue(2028));
			getExtended().maxMsgLengthSetValue(
					pcfmessage.getIntParameterValue(1510));
			getExtended().heartBeatIntervalSetValue(
					pcfmessage.getIntParameterValue(1563));
			getExtended().seqNumberWrapSetValue(
					pcfmessage.getIntParameterValue(1509));
			getExtended().nonPersistentMsgSpeedSetValue(
					pcfmessage.getIntParameterValue(1562));
			getExtended().batchSizeSetValue(
					pcfmessage.getIntParameterValue(1502));
			getExtended().batchIntervalSetValue(
					pcfmessage.getIntParameterValue(1564));
			getExtended().discIntervalSetValue(
					pcfmessage.getIntParameterValue(1503));
			getExtended().dataConversionSetValue(
					pcfmessage.getIntParameterValue(1515));
			getExtended().putAuthoritySetValue(
					pcfmessage.getIntParameterValue(1508));
			...
			getExits().sendExitSetValue(
					pcfmessage.getStringParameterValue(3510));
			getExits().sendUserDataSetValue(
					pcfmessage.getStringParameterValue(3515));
			getExits().receiveExitSetValue(
					pcfmessage.getStringParameterValue(3511));
			getExits().receiveUserDataSetValue(
					pcfmessage.getStringParameterValue(3516));
			getExits().securityExitSetValue(
					pcfmessage.getStringParameterValue(3508));
			getExits().securityUserDataSetValue(
					pcfmessage.getStringParameterValue(3513));
			getExits()
					.msgExitSetValue(pcfmessage.getStringParameterValue(3509));
			getExits().msgUserDataSetValue(
					pcfmessage.getStringParameterValue(3514));
			...
			getRetry().msgRetryCountSetValue(
					pcfmessage.getIntParameterValue(1544));
			getRetry().msgRetryIntervalSetValue(
					pcfmessage.getIntParameterValue(1545));
			getRetry().msgRetryExitSetValue(
					pcfmessage.getStringParameterValue(3534));
			getRetry().msgRetryUserDataSetValue(
					pcfmessage.getStringParameterValue(3535));
			setTitle("Cluster receiver channel " + s.trim() + " Properties");
		} catch (Exception exception) {
			System.out
					.println("changeClusterReceiver: " + exception.toString());
		}
		pack();
	...
	public void changeClusterSender(Frame frame,
			QueueManagerModel queuemanagermodel, String s) {
		queueManagerModel = queuemanagermodel;
		type = 2;
		try {
			...
			getMCA().MCAUserIdentifierSetValue(
					pcfmessage.getStringParameterValue(3527));
			getMCA().MCATypeSetValue(pcfmessage.getIntParameterValue(1517));
			getMCA().MCANameSetVisible(false);
			getExits().sendExitSetValue(
					pcfmessage.getStringParameterValue(3510));
			...
			getExits().msgUserDataSetValue(
					pcfmessage.getStringParameterValue(3514));
			getRetry().shortRetryCountSetValue(
					pcfmessage.getIntParameterValue(1505));
			getRetry().shortRetryIntervalSetValue(
					pcfmessage.getIntParameterValue(1504));
			getRetry().longRetryCountSetValue(
					pcfmessage.getIntParameterValue(1507));
			getRetry().longRetryIntervalSetValue(
					pcfmessage.getIntParameterValue(1506));
			...
			logger.info("changeClusterSender: " + exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
		setVisible(true);
	...
	public void changeReceiver(Frame frame,
			QueueManagerModel queuemanagermodel, String s) {
		queueManagerModel = queuemanagermodel;
		type = 2;
		try {
			...
			logger.info("changeReceiver: " + exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
		setVisible(true);
	...
	public void changeRequester(Frame frame,
			QueueManagerModel queuemanagermodel, String s) {
		queueManagerModel = queuemanagermodel;
		type = 2;
		try {
			...
			logger.info("changeRequester: " + exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
		setVisible(true);
	...
	public void changeSender(Frame frame, QueueManagerModel queuemanagermodel,
			String s) {
		queueManagerModel = queuemanagermodel;
		type = 2;
		try {
			...
			getGeneral().connectionNameSetValue(
					pcfmessage.getStringParameterValue(3506));
			getGeneral().xmitQNameSetValue(
					pcfmessage.getStringParameterValue(3505));
			getGeneral()
					.xmitQNameInit(
							queuemanagermodel.getQueueListModel()
									.getLocalQueueNames(4));
			getGeneral().alterationDateSetValue(
					pcfmessage.getStringParameterValue(2027));
			getGeneral().alterationTimeSetValue(
					pcfmessage.getStringParameterValue(2028));
			...
			logger.info("changeSender: " + exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
		setVisible(true);
	...
	public void changeServer(Frame frame, QueueManagerModel queuemanagermodel,
			String s) {
		queueManagerModel = queuemanagermodel;
		type = 2;
		try {
			...
			logger.info("changeServer: " + exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
		setVisible(true);
	...
	public void changeServerConnection(Frame frame,
			QueueManagerModel queuemanagermodel, String s) {
		queueManagerModel = queuemanagermodel;
		type = 2;
		try {
			...
			logger.info("changeServerConnection: "
					+ exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
	...
	public void createClusterReceiverChannel(Frame frame,
			QueueManagerModel queuemanagermodel) {
		queueManagerModel = queuemanagermodel;
		type = 1;
		try {
			PCFMessage pcfmessage = queuemanagermodel.getChannelListModel()
					.findChannelByName("SYSTEM.DEF.CLUSRCVR");
			...
			logger.info("createClusterReceiverChannel: "
					+ exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
	...
	public void createClusterSenderChannel(Frame frame,
			QueueManagerModel queuemanagermodel) {
		queueManagerModel = queuemanagermodel;
		type = 1;
		try {
			PCFMessage pcfmessage = queuemanagermodel.getChannelListModel()
					.findChannelByName("SYSTEM.DEF.CLUSSDR");
			...
			logger.info("createClusterSenderChannel: "
					+ exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
	...
	public void createReceiverChannel(Frame frame,
			QueueManagerModel queuemanagermodel) {
		queueManagerModel = queuemanagermodel;
		type = 1;
		try {
			PCFMessage pcfmessage = queuemanagermodel.getChannelListModel()
					.findChannelByName("SYSTEM.DEF.RECEIVER");
			...
			System.out
					.println("createReceiverChannel: " + exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
		setVisible(true);
	...
	public void createRequesterChannel(Frame frame,
			QueueManagerModel queuemanagermodel) {
		queueManagerModel = queuemanagermodel;
		type = 1;
		try {
			PCFMessage pcfmessage = queuemanagermodel.getChannelListModel()
					.findChannelByName("SYSTEM.DEF.REQUESTER");
			...
			logger.info("createRequesterChannel: "
					+ exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
	...
	public void createSenderChannel(Frame frame,
			QueueManagerModel queuemanagermodel) {
		queueManagerModel = queuemanagermodel;
		type = 1;
		try {
			PCFMessage pcfmessage = queuemanagermodel.getChannelListModel()
					.findChannelByName("SYSTEM.DEF.SENDER");
			...
			logger.info("createSenderChannel: " + exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
		setVisible(true);
	...
	public void createServerChannel(Frame frame,
			QueueManagerModel queuemanagermodel) {
		queueManagerModel = queuemanagermodel;
		type = 1;
		try {
			PCFMessage pcfmessage = queuemanagermodel.getChannelListModel()
					.findChannelByName("SYSTEM.DEF.SERVER");
			...
			logger.info("createServerChannel: " + exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
		setVisible(true);
	...
	public void createServerConnectionChannel(Frame frame,
			QueueManagerModel queuemanagermodel) {
		queueManagerModel = queuemanagermodel;
		type = 1;
		try {
			PCFMessage pcfmessage = queuemanagermodel.getChannelListModel()
					.findChannelByName("SYSTEM.DEF.SVRCONN");
			...
			logger.info("createServerConnectionChannel: "
					+ exception.toString());
		}
		pack();
		SwingUtils.setCenter(frame, this);
	...
	public void doChangeClusterReceiver() throws MQException {
		...
		pcfmessage
				.addParameter(1563, getExtended().heartBeatIntervalGetValue());
		pcfmessage.addParameter(1509, getExtended().seqNumberWrapGetValue());
		pcfmessage.addParameter(1562, getExtended()
				.nonPersistentMsgSpeedGetValue());
		...
		try {
			...
			logger.info("doChangeClusterReceiver: "
					+ pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doChangeClusterSender() throws MQException {
		PCFMessage pcfmessage = new PCFMessage(21);
		pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
		pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
		pcfmessage.addParameter(3502, getGeneral().channelDescGetValue());
		...
		try {
			...
			logger.info("doChangeClusterSender: "
					+ pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doChangeReceiver() throws MQException {
		PCFMessage pcfmessage = new PCFMessage(21);
		pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
		pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
		pcfmessage.addParameter(3502, getGeneral().channelDescGetValue());
		...
		try {
			...
			logger.info("doChangeReceiver: " + pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doChangeRequester() throws MQException {
		PCFMessage pcfmessage = new PCFMessage(21);
		pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
		pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
		pcfmessage.addParameter(3502, getGeneral().channelDescGetValue());
	...
	public void doChangeSender() throws MQException {
		PCFMessage pcfmessage = new PCFMessage(21);
		pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
		pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
		pcfmessage.addParameter(3502, getGeneral().channelDescGetValue());
		...
		try {
			...
			logger.info("doChangeSender: " + pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doChangeServer() throws MQException {
		PCFMessage pcfmessage = new PCFMessage(21);
		pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
		pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
		pcfmessage.addParameter(3502, getGeneral().channelDescGetValue());
		...
		try {
			...
			logger.info("doChangeServer: " + pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doChangeServerConnection() throws MQException {
		PCFMessage pcfmessage = new PCFMessage(21);
		pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
		pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
		pcfmessage.addParameter(3502, getGeneral().channelDescGetValue());
		...
		try {
			...
			logger.info("doChangeServerConnection: "
					+ pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doCreateClusterReceiver() throws MQException {
		try {
			PCFMessage pcfmessage = new PCFMessage(23);
			pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
			pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
			pcfmessage
					.addParameter(3506, getGeneral().connectionNameGetValue());
			pcfmessage.addParameter(1501, getGeneral().transportTypeGetValue());
			pcfmessage.addParameter(1510, getExtended().maxMsgLengthGetValue());
			pcfmessage.addParameter(1563, getExtended()
					.heartBeatIntervalGetValue());
			pcfmessage
					.addParameter(1509, getExtended().seqNumberWrapGetValue());
			pcfmessage.addParameter(1562, getExtended()
					.nonPersistentMsgSpeedGetValue());
			pcfmessage.addParameter(1502, getExtended().batchSizeGetValue());
			pcfmessage
					.addParameter(1564, getExtended().batchIntervalGetValue());
			pcfmessage.addParameter(1503, getExtended().discIntervalGetValue());
			pcfmessage.addParameter(1515, getExtended()
					.dataConversionGetValue());
			pcfmessage.addParameter(1508, getExtended().putAuthorityGetValue());
			pcfmessage.addParameter(1517, getMCA().MCATypeGetValue());
			pcfmessage.addParameter(3510, getExits().sendExitGetValue());
			pcfmessage.addParameter(3515, getExits().sendUserDataGetValue());
			...
			pcfmessage.addParameter(3508, getExits().securityExitGetValue());
			pcfmessage
					.addParameter(3513, getExits().securityUserDataGetValue());
			pcfmessage.addParameter(3509, getExits().msgExitGetValue());
			pcfmessage.addParameter(3514, getExits().msgUserDataGetValue());
			pcfmessage.addParameter(1544, getRetry().msgRetryCountGetValue());
			pcfmessage
					.addParameter(1545, getRetry().msgRetryIntervalGetValue());
			pcfmessage.addParameter(3534, getRetry().msgRetryExitGetValue());
			pcfmessage
					.addParameter(3535, getRetry().msgRetryUserDataGetValue());
			queueManagerModel.executePCF(pcfmessage);
		} catch (PCFException pcfexception) {
			logger.info("doCreateClusterReceiver: "
					+ pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doCreateClusterSender() throws MQException {
		try {
			PCFMessage pcfmessage = new PCFMessage(23);
			pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
			pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
			...
			pcfmessage.addParameter(3514, getExits().msgUserDataGetValue());
			pcfmessage.addParameter(1505, getRetry().shortRetryCountGetValue());
			pcfmessage.addParameter(1504, getRetry()
					.shortRetryIntervalGetValue());
			pcfmessage.addParameter(1507, getRetry().longRetryCountGetValue());
			pcfmessage.addParameter(1506, getRetry()
					.longRetryIntervalGetValue());
			queueManagerModel.executePCF(pcfmessage);
		} catch (PCFException pcfexception) {
			logger.info("doCreateClusterSender: "
					+ pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doCreateReceiver() throws MQException {
		try {
			PCFMessage pcfmessage = new PCFMessage(23);
			pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
			pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
			...
			logger.info("doCreateReceiver: " + pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doCreateRequester() throws MQException {
		try {
			PCFMessage pcfmessage = new PCFMessage(23);
			pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
			pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
			...
			logger.info("doCreateRequester: " + pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doCreateSender() throws MQException {
		try {
			PCFMessage pcfmessage = new PCFMessage(23);
			pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
			pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
			...
			logger.info("doCreateSender: " + pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doCreateServer() throws MQException {
		try {
			PCFMessage pcfmessage = new PCFMessage(23);
			pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
			pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
			...
			logger.info("doCreateServer: " + pcfexception.toString());
			throw pcfexception;
		}
	}

	public void doCreateServerConnection() throws MQException {
		try {
			PCFMessage pcfmessage = new PCFMessage(23);
			pcfmessage.addParameter(3501, getGeneral().channelNameGetValue());
			pcfmessage.addParameter(1511, getGeneral().channelTypeGetValue());
			...
			logger.info("doCreateServerConnection: "
					+ pcfexception.toString());
			throw pcfexception;
		}
	}
		...
		if (ivjJDialogContentPane == null)
			try {
				...
				getJDialogContentPane()
						.add(getTabbedPane(), gridbagconstraints);
	...
	private JTabbedPane getTabbedPane() {
		if (ivjTabbedPane == null)
			try {
				...
				ivjTabbedPane.insertTab("Extended", null, getExtended(), null,
						1);
	...
	public static void main(String args[]) {
		try {
			...
			channeldlg.setSize(channeldlg.getWidth() + insets.left
					+ insets.right, channeldlg.getHeight() + insets.top
					+ insets.bottom);
	...
	public void oK_ActionEvents() {
		try {
			if (type == 1)
				...
				case 6: // '\006'
				default:
					logger.info("Unhandled create type");
					break;
				}
			else if (type == 2)
				switch (getGeneral().channelTypeGetValue()) {
				...
				case 6: // '\006'
				default:
					logger.info("Unhandled change type");
					break;
				}
			dispose();
