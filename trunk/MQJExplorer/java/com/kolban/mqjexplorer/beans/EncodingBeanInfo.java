...
// Source File Name:   EncodingBeanInfo.java
...
public class EncodingBeanInfo extends SimpleBeanInfo
{

    public EncodingBeanInfo()
    {
    }
    ...
    {
        return com.kolban.mqjexplorer.beans.Encoding.class;
    }

    public static String getBeanClassName()
    {
        return "com.kolban.mqjexplorer.beans.Encoding";
    }
    ...
    public BeanDescriptor getBeanDescriptor()
    {
        ...
        try
        {
            beandescriptor = new BeanDescriptor(com.kolban.mqjexplorer.beans.Encoding.class);
        }
        catch(Throwable _ex) { }
    ...
    public MethodDescriptor getIntValueMethodDescriptor()
    {
        ...
        try
        {
            ...
            {
                Class aclass[] = new Class[0];
                method = getBeanClass().getMethod("getIntValue", aclass);
            }
            catch(Throwable throwable1)
            {
                handleException(throwable1);
                method = findMethod(getBeanClass(), "getIntValue", 0);
            }
            try
            {
    ...
    public MethodDescriptor[] getMethodDescriptors()
    {
        try
        {
            MethodDescriptor amethoddescriptor[] = {
                getIntValueMethodDescriptor(), main_javalangString__MethodDescriptor(), select_Mouse_javaawteventMouseEventMethodDescriptor()
            };
    ...
    public MethodDescriptor select_Mouse_javaawteventMouseEventMethodDescriptor()
    {
        MethodDescriptor methoddescriptor = null;
        try
        {
            ...
            try
            {
                ...
                method = getBeanClass().getMethod("select_Mouse", aclass);
            }
            catch(Throwable throwable1)
            {
                handleException(throwable1);
                method = findMethod(getBeanClass(), "select_Mouse", 1);
            }
            try
            {
                ParameterDescriptor parameterdescriptor = new ParameterDescriptor();
