...
// Source File Name:   StatusBarBeanInfo.java
...
public class StatusBarBeanInfo extends SimpleBeanInfo
{
    ...
    {
        return com.kolban.mqjexplorer.guibeans.StatusBar.class;
    }

    public static String getBeanClassName()
    {
        return "com.kolban.mqjexplorer.guibeans.StatusBar";
    }
    ...
    public BeanDescriptor getBeanDescriptor()
    {
        ...
        try
        {
            beandescriptor = new BeanDescriptor(com.kolban.mqjexplorer.guibeans.StatusBar.class);
        }
        catch(Throwable _ex) { }
    ...
    public PropertyDescriptor[] getPropertyDescriptors()
    {
        try
        {
            PropertyDescriptor apropertydescriptor[] = {
                componentOrientationPropertyDescriptor(), messageTextPropertyDescriptor()
            };
    ...
    public PropertyDescriptor messageTextPropertyDescriptor()
    {
        PropertyDescriptor propertydescriptor = null;
        try
        {
            try
            {
                ...
                try
                {
                    ...
                    method1 = getBeanClass().getMethod("setMessageText", aclass);
                }
                catch(Throwable throwable2)
                {
                    handleException(throwable2);
                    method1 = findMethod(getBeanClass(), "setMessageText", 1);
                }
                propertydescriptor = new PropertyDescriptor("messageText", method, method1);
            }
            catch(Throwable throwable)
            {
                handleException(throwable);
                propertydescriptor = new PropertyDescriptor("messageText", getBeanClass());
            }
            propertydescriptor.setDisplayName("message text");
        }
        catch(Throwable throwable1)
        {
            handleException(throwable1);
