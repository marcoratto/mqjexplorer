...
// Source File Name:   QueueAliasGeneralPane.java
...
public class QueueAliasGeneralPane extends JPanel
{

    public QueueAliasGeneralPane()
    {
        ivjJLabel = null;
        ivjJLabel1 = null;
        ivjJLabel2 = null;
        ...
        ivjQName = null;
        ivjQType = null;
        ivjBaseQueueName = null;
        ivjJPanel1 = null;
        initialize();
    }

    public QueueAliasGeneralPane(LayoutManager layoutmanager)
    {
        super(layoutmanager);
        ivjJLabel = null;
        ivjJLabel1 = null;
    ...
    public QueueAliasGeneralPane(LayoutManager layoutmanager, boolean flag)
    {
    ...
    public QueueAliasGeneralPane(boolean flag)
    {
        super(flag);
        ivjJLabel = null;
        ivjJLabel1 = null;
    ...
    public String baseQueueNameGetValue()
    {
        return getBaseQueueName().getValue();
    }

    public void baseQueueNameInit(String as[])
    {
        getBaseQueueName().init(as);
    }

    public void baseQueueNameSetValue(String s)
    {
        getBaseQueueName().setValue(s);
    }
    ...
    private BaseQueueName getBaseQueueName()
    {
        if(ivjBaseQueueName == null)
            try
            {
                ivjBaseQueueName = new BaseQueueName();
                ivjBaseQueueName.setName("BaseQueueName");
            }
            catch(Throwable throwable)
            {
                handleException(throwable);
            }
        return ivjBaseQueueName;
    }
    ...
    private JLabel getJLabel()
    {
        if(ivjJLabel == null)
            try
            {
                ...
                ivjJLabel.setText("Base Queue Name:");
            }
            catch(Throwable throwable)
            {
                handleException(throwable);
    ...
    private void initialize()
    {
        try
        {
            ...
            add(getQName(), gridbagconstraints13);
            ...
            add(getDefPriority(), gridbagconstraints14);
            ...
            add(getQDesc(), gridbagconstraints15);
            ...
            add(getBaseQueueName(), gridbagconstraints17);
    ...
    private BaseQueueName ivjBaseQueueName;
