...
// Source File Name:   XATopicConnectionFactoryDlg.java
...
public class XATopicConnectionFactoryDlg extends JDialog
{
        ...
        implements FooterListener, WindowListener
    {
        ...
        {
            if(windowevent.getSource() == XATopicConnectionFactoryDlg.this)
    ...
    public XATopicConnectionFactoryDlg()
    {
        ivjFooter = null;
        ivjGeneral = null;
    ...
    public XATopicConnectionFactoryDlg(Dialog dialog)
    {
        super(dialog);
        ivjFooter = null;
        ivjGeneral = null;
    ...
    public XATopicConnectionFactoryDlg(Dialog dialog, String s)
    {
        super(dialog, s);
        ivjFooter = null;
        ivjGeneral = null;
    ...
    public XATopicConnectionFactoryDlg(Dialog dialog, String s, boolean flag)
    {
        super(dialog, s, flag);
        ivjFooter = null;
        ivjGeneral = null;
    ...
    public XATopicConnectionFactoryDlg(Dialog dialog, boolean flag)
    {
        super(dialog, flag);
        ivjFooter = null;
        ivjGeneral = null;
    ...
    public XATopicConnectionFactoryDlg(Frame frame)
    {
        super(frame);
        ivjFooter = null;
        ivjGeneral = null;
    ...
    public XATopicConnectionFactoryDlg(Frame frame, String s)
    {
        super(frame, s);
        ivjFooter = null;
        ivjGeneral = null;
    ...
    public XATopicConnectionFactoryDlg(Frame frame, String s, boolean flag)
    {
        super(frame, s, flag);
        ivjFooter = null;
        ivjGeneral = null;
    ...
    public XATopicConnectionFactoryDlg(Frame frame, boolean flag)
    {
        super(frame, flag);
        ivjFooter = null;
        ivjGeneral = null;
    ...
    public MQXATopicConnectionFactory getXATopicConnectionFactory()
    {
    ...
    public void setFromXATopicConnectionFactory(MQXATopicConnectionFactory mqxatopicconnectionfactory)
    {
