...
// Source File Name:   PropertiesRemoteQueue.java
...
public class PropertiesRemoteQueue extends JDialog
{
    ...
    public PropertiesRemoteQueue(Dialog dialog)
    {
        super(dialog);
        ivjJDialogContentPane = null;
        ivjJTabbedPane1 = null;
    ...
    public PropertiesRemoteQueue(Dialog dialog, String s)
    {
        super(dialog, s);
        ivjJDialogContentPane = null;
        ivjJTabbedPane1 = null;
    ...
    public PropertiesRemoteQueue(Dialog dialog, String s, boolean flag)
    {
        super(dialog, s, flag);
        ivjJDialogContentPane = null;
        ivjJTabbedPane1 = null;
    ...
    public PropertiesRemoteQueue(Dialog dialog, boolean flag)
    {
        super(dialog, flag);
        ivjJDialogContentPane = null;
        ivjJTabbedPane1 = null;
    ...
    public PropertiesRemoteQueue(Frame frame)
    {
        super(frame);
        ivjJDialogContentPane = null;
        ivjJTabbedPane1 = null;
    ...
    public PropertiesRemoteQueue(Frame frame, String s)
    {
        super(frame, s);
        ivjJDialogContentPane = null;
        ivjJTabbedPane1 = null;
    ...
    public PropertiesRemoteQueue(Frame frame, String s, boolean flag)
    {
        super(frame, s, flag);
        ivjJDialogContentPane = null;
        ivjJTabbedPane1 = null;
    ...
    public PropertiesRemoteQueue(Frame frame, boolean flag)
    {
        super(frame, flag);
        ivjJDialogContentPane = null;
        ivjJTabbedPane1 = null;
