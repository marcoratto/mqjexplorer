...
// Source File Name:   QueueModelGeneralPane.java
...
public class QueueModelGeneralPane extends JPanel
{

    public QueueModelGeneralPane()
    {
        ivjJLabel = null;
        ivjJLabel1 = null;
        ivjJLabel2 = null;
    ...
    public QueueModelGeneralPane(LayoutManager layoutmanager)
    {
        super(layoutmanager);
        ivjJLabel = null;
        ivjJLabel1 = null;
    ...
    public QueueModelGeneralPane(LayoutManager layoutmanager, boolean flag)
    {
    ...
    public QueueModelGeneralPane(boolean flag)
    {
        super(flag);
        ivjJLabel = null;
        ivjJLabel1 = null;
    ...
    private void initialize()
    {
        try
        {
            ...
            add(getJLabel(), gridbagconstraints7);
            ...
            add(getInhibitPut(), gridbagconstraints8);
            ...
            add(getInhibitGet(), gridbagconstraints9);
            ...
            add(getDefPersistence(), gridbagconstraints10);
            ...
            add(getUsage(), gridbagconstraints11);
            ...
            add(getQName(), gridbagconstraints12);
            ...
            add(getDefPriority(), gridbagconstraints13);
            ...
            add(getQDesc(), gridbagconstraints14);
            ...
            add(getQType(), gridbagconstraints16);
        }
        catch(Throwable throwable)
        {
            handleException(throwable);
