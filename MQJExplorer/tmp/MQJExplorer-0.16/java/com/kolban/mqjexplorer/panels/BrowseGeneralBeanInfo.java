...
// Source File Name:   BrowseGeneralBeanInfo.java
...
public class BrowseGeneralBeanInfo extends SimpleBeanInfo
{

    public BrowseGeneralBeanInfo()
    {
    }
    ...
    {
        return com.kolban.mqjexplorer.panels.BrowseGeneral.class;
    }

    public static String getBeanClassName()
    {
        return "com.kolban.mqjexplorer.panels.BrowseGeneral";
    }
    ...
    public BeanDescriptor getBeanDescriptor()
    {
        ...
        try
        {
            beandescriptor = new BeanDescriptor(com.kolban.mqjexplorer.panels.BrowseGeneral.class);
        }
        catch(Throwable _ex) { }
